...
float lastX = 400, lastY = 300; // 鼠标最大偏移量
...
int main() {
	...
	glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); // 无光标模式
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // clear colorbuffer and depth buffer
